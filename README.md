...
4. สร้าง Markdown และ Mermaid architecture maps ที่มีประโยชน์
5. ทิ้ง handoff notes ที่ AI agents ในอนาคตใช้ได้ทันที
6. หลีกเลี่ยง unsupported claims, decorative documentation, และ overengineering
...
รุ่นถัดไป (unreleased) ตัด Idea-to-Architecture Mode ออกจาก skill นี้ งานไอเดียดิบทั้งหมด route ไปที่ sibling skill `idea-to-architecture-agent` เพื่อให้ skill นี้โฟกัสแก่นเดียว: เข้าใจระบบที่มีอยู่จริงแล้วกางออกมาเป็นเอกสารที่ตรวจสอบได้ ดูรายละเอียดใน [CHANGELOG.md](CHANGELOG.md)
