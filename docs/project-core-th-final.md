...
แต่เพราะ core skill ต้องรักษาความคมของการเป็น architecture skill ก่อน ไม่ใช่กลายเป็นระบบขนาดใหญ่
ที่ขอบเขตเบลอ
...
v1.0.0 ยังควรรักษา Mermaid เป็น diagram source of truth

---

### v1.1.0 - SVG Visual Artifact Completion

เป้าหมายคือเพิ่ม SVG visual artifact จาก Mermaid diagram ตัวอย่าง
เพื่อช่วยการนำเสนอ การฝังใน README หรือการรีวิวภาพรวม
โดยยังรักษา Mermaid/SVG checks ให้เบาและตรวจสอบได้

ควรมี:

- SVG visual artifact สำหรับ example output package อย่างน้อยหนึ่งชิ้น
- Mermaid diagram เป็น source of truth ที่แก้ไขและ diff ได้
- SVG เป็น generated artifact เท่านั้น ไม่ใช่ architecture source หลัก
- เอกสาร operational ที่อธิบายบทบาท SVG ให้ตรงกัน
...
ส่วนที่ไม่เกี่ยวกับ Mermaid/SVG checks ควรถูกตัดออกจากแกนหลัก
