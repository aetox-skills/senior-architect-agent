...
- A discipline layer for architecture work.
- A repeatable inspection and documentation workflow.
- A way to create architecture notes that future AI agents can read quickly.
- A guard against unsupported assumptions.
